// ============================================
// LANDING PAGE - Apple Design with Transparent Sections
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center px-6 pt-20 pb-16 overflow-hidden">
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <Link to="/products">
              <button className="flex items-center gap-2 px-8 py-4 bg-white/70 backdrop-blur-md text-gray-900 font-medium rounded-full border border-white/50 shadow-lg hover:bg-white/90 hover:shadow-xl transition-all duration-300 hover:scale-[1.02] active:scale-[0.98]">
      ...
      <section className="py-24 px-6 bg-white/50 backdrop-blur-sm">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Link to="/products">
              <button className="px-8 py-4 text-[#007AFF] font-medium rounded-full hover:bg-blue-500/10 transition-all duration-300">
                Learn More
              </button>
            </Link>
          </div>
